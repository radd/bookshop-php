...
$("#add_new_author").click( function() {
    ...
    if(name != '') {
        $("#add_new_author_div").append("<label><input name='author[]' value='" + name + "," + lastname + "' type='checkbox' checked> " + name + " " + lastname + "</label>");
...
$("#add_new_cat").click( function() {
    ...
    if(name != '') {
        $("#add_new_cat_div").append("<label><input name='cat[]' value='" + name + "' type='checkbox' checked> " + name + "</label>");
...
$("#add_new_pub").click( function() {
    ...
    if(name != '') {
        $("#add_new_pub_div").append("<label><input name='pub' value='" + name + "' type='radio' checked> " + name + "</label>");
